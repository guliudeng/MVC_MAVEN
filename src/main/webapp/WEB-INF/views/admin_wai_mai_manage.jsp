...
<script type="text/html" id="toolbarDemo">
    ...
    <div class="layui-form-item">
        <div class="layui-input-inline">
            <input type="text" id="userName" name="userName" class="layui-input" placeholder="输入查询的配送人员" autocomplete="off">
        </div>
...
<script>
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,url:'${pageContext.request.contextPath}/qryWaiMai'
            ...
            ,cols: [[
                // {type:'checkbox'}//添加复选框
                {field:'waiMaiId', width:80, title: '配送员ID', sort: true}
                ,{field:'waiMaiName', width:100, title: '姓名'}
                ,{field:'waiMaiPhone', width:80, title: '电话'}
                //,{field:'waiMaiAddress',  title: '图片', templet:"#imgtmp"}
                // ,{field:'sign', title: '签名', width: '30%', minWidth: 100} //minWidth：局部定义当前单元格的最小宽度，layui 2.2.1 新增
                ,{field:'waiMaiAddress', width:100,title: '配送人员地址'}
                ,{field:'tenantId',width:100, title: '所属商家'}
