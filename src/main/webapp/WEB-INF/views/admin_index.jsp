...
<body class="layui-layout-body layui-all">
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        ...
        <div class="layui-header-content">
            <a>
                <div class="layui-tool"><i title="展开" class="fa fa-outdent" data-side-fold="1"></i></div>
            </a>

            <!--电脑端头部菜单-->
            <ul class="layui-nav layui-layout-left layui-header-menu layui-menu-header-pc layui-pc-show">
            </ul>
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    <a href="javascript:;" data-clear="清理" class="layui-clear"><i class="fa fa-trash-o"></i></a>
                </li>
    ...
    <div class="layui-loader">
        <div class="layui-loader-inner"></div>
    </div>
    ...
    <!-- 移动导航 -->
    <div class="layui-site-mobile"><i class="layui-icon"></i></div>

    <div class="layui-body">

        <div class="layui-tab layui-tab-rollTool layui-tab" lay-filter="layuiTab" lay-allowclose="true">
            <ul class="layui-tab-title">
                <li class="layui-this" id="layuiHomeTabId" lay-id=""></li>
            </ul>
            <div class="layui-tab-control">
                <li class="layui-tab-roll-left layui-icon layui-icon-left"></li>
                <li class="layui-tab-roll-right layui-icon layui-icon-right"></li>
            ...
            <div class="layui-tab-content">
                <div id="layuiHomeTabIframe" class="layui-tab-item layui-show"></div>
            </div>
        </div>
