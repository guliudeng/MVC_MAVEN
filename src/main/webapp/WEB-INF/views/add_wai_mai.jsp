...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="waiMaiName" lay-verify="required" lay-reqtext="姓名不能为空" placeholder="请输入姓名" value="" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        form.on('submit(saveBtn)', function (data) {
            ...
            var index = layer.alert(data1, {
                ...
                $.ajax({
                    type: "post",
                    dataType: "json",
                    url: '${pageContext.request.contextPath}/addWaiMaiInterface',
                    data: data1,
