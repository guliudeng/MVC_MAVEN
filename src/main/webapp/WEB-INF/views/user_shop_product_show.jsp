...
<div class="layui-form-item layui-hide">
    <label class="layui-form-label required">TenantId</label>
    <div class="layui-input-block">
        <input type="text" name="tenantId"  id = "tenantId" value="" class="layui-input">
    </div>
</div>
    ...
    layui.use('table', function(){
        ...
        $ = layui.jquery
            table.render({
                ...
                // where:
                ,url:'${pageContext.request.contextPath}/qryProductUser?tenantId='+tenantId
